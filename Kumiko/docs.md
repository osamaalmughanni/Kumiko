...
A: Kumiko detects uninstalled Dynamo packages and notifies the user. However, the tool does not automatically install the missing packages. We are working on implementing auto-detection and auto-installation in the future.
